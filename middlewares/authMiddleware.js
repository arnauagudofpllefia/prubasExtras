...
// Després del middleware protegir, afegir:

// autoritzar(...rols): retorna un middleware que comprova que req.usuari.rol estigui dins de rols.
// S'ha d'usar després de protegir, perquè req.usuari ja ha d'estar definit.
